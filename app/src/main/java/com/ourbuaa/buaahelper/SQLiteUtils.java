...
public class SQLiteUtils {
    ...
    public String GetNotificationsOrderByUpdateTime(int from, int size, String owner) {
        ...
        final String SQL_DATA_QUERY_LASTUserNToken = "SELECT id,updated_at,title,author,content,files,star,show,read,department FROM notifications WHERE (owner= ? AND show=1)ORDER BY updated_at DESC LIMIT ? OFFSET ?";
    ...
    public String GetFAVNotificationsOrderByUpdateTime(int from, int size, String owner) {
        ...
        final String SQL_DATA_QUERY_LASTUserNToken = "SELECT id,updated_at,title,author,content,files,star,show,read,department FROM notifications WHERE (owner= ? AND show=1 AND star=1)ORDER BY updated_at DESC LIMIT ? OFFSET ?";
    ...
    public String GetTrashNotificationsOrderByUpdateTime(int from, int size, String owner) {

        final String SQL_DATA_QUERY_LASTUserNToken = "SELECT id,updated_at,title,author,content,files,star,show,read,department FROM notifications WHERE (owner= ? AND show=0)ORDER BY updated_at DESC LIMIT ? OFFSET ?";
    ...
    public String GetNotificationByID(long id) {
        ...
        final String SQL_DATA_QUERY_LASTUserNToken = "SELECT id,updated_at,title,author,content,files,star,show,read,department FROM notifications WHERE id= ? ";
    ...
    public void HideNotificationByID(long id) {
        final String SQL_DATA_UPDATE = "UPDATE notifications SET show=0 WHERE id=?";
        db.execSQL(SQL_DATA_UPDATE, new Object[]{"" + id});
    }

    public void SeekNotificationByID(long id) {
        final String SQL_DATA_UPDATE = "UPDATE notifications SET show=1 WHERE id=?";
        db.execSQL(SQL_DATA_UPDATE, new Object[]{"" + id});
    }

    public void ReadNotificationByID(long id) {
        final String SQL_DATA_UPDATE = "UPDATE notifications SET read=1 WHERE id=?";
        db.execSQL(SQL_DATA_UPDATE, new Object[]{"" + id});
    }
